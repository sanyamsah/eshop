...
int main()
{
    ...
    scanf("%d%d", &x3, &y3);
    if ((dist(x1, y1, x2, y2) + dist(x2, y2, x3, y3)) > dist(x3, y3, x1, y1) &&
        (dist(x3, y3, x1, y1) + dist(x1, y1, x2, y2)) > dist(x2, y2, x3, y3) &&
        (dist(x2, y2, x3, y3) + dist(x3, y3, x1, y1)) > dist(x1, y1, x2, y2))
    {
    ...
    if (flag == 1)
    {
        ...
        s = (dist(x1, y1, x2, y2) + dist(x2, y2, x3, y3) + dist(x3, y3, x1, y1))/2.0;
